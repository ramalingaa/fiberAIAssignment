...
var createTable = function (tableName, headers, sampleData, knex) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                console.log("----tanle creation started---");
                return [4 /*yield*/, knex.schema.dropTableIfExists(tableName)];
            case 1:
                _a.sent();
                return [4 /*yield*/, knex.schema.createTable(tableName, function (table) {
                        headers.forEach(function (header) {
                            // Determine the type based on the sample data
                            var sampleValue = sampleData[header];
                            if (typeof parseFloat(sampleValue) === 'number' && isFinite(parseFloat((sampleValue)))) {
                                ...
                                var numValue = parseFloat(sampleValue);
