    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                ...
                return [4 /*yield*/, (0, _1.parseCSVFile)(csvFilePath)];
            case 3:
                data = _a.sent();
                tableName = path.basename(file, '.csv');
                sampleData = data[0];
                return [4 /*yield*/, (0, _1.createTable)(tableName, Object.keys(sampleData), sampleData, knex)];
            case 4:
                _a.sent();
                return [4 /*yield*/, (0, _1.batchInsertData)(knex, tableName, data)];
            case 5:
                _a.sent();
                _a.label = 6;
            case 6:
